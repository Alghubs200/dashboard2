  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {},
          backgroundColor: Color.fromARGB(255, 241, 8, 86),
          child: Icon(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  //send button
                  MyButton(
                      iconImagePath: 'icons/money.png', buttonText: 'Send'),
                  //pay button
                  MyButton(
                      iconImagePath: 'icons/credit.png', buttonText: 'Pay'),
                  //bills button
                  MyButton(
                      iconImagePath: 'icons/bill.png', buttonText: 'Bills'),
                ],
              ),
            ),
            Padding(
